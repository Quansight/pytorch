...
#define AXPY_SPECIALIZATION(ctype, name, _1)                                  \
  template <>                                                                 \
  inline void THBlas_axpy<ctype>(                                             \
      int64_t n, ctype a, ctype * x, int64_t incx, ctype * y, int64_t incy) { \
...
#define COPY_SPECIALIZATION(ctype, name, _1)                         \
  template <>                                                        \
  inline void THBlas_copy<ctype>(                                    \
      int64_t n, ctype * x, int64_t incx, ctype * y, int64_t incy) { \
...
#define VOL2COL_SPECIALIZATION(ctype, name, _1) \
  template <>                                   \
  inline void THBlas_vol2col<ctype>(            \
      const ctype* data_im,                     \
      const int64_t channels,                   \
      const int64_t depth,                      \
      const int64_t height,                     \
...
AT_FORALL_SCALAR_TYPES_EXCEPT_HALF_AND_QINT(VOL2COL_SPECIALIZATION)

template <typename T>
inline void THBlas_col2vol(
    const T* data_col,
    const int64_t channels,
    const int64_t depth,
    const int64_t height,
...
#define COL2VOL_SPECIALIZATION(ctype, name, _1) \
  template <>                                   \
  inline void THBlas_col2vol<ctype>(            \
      const ctype* data_col,                    \
      const int64_t channels,                   \
      const int64_t depth,                      \
      const int64_t height,                     \
...
AT_FORALL_SCALAR_TYPES_EXCEPT_HALF_AND_QINT(COL2VOL_SPECIALIZATION)
