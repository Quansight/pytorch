...
SparseTensor& sqrt_out_sparse(SparseTensor& r, const SparseTensor& t) {
  sparse_unary_op_check_and_init<true>(r, t);
  r._values().sqrt_();
  return r;
}
...
SparseTensor& asinh_out_sparse(SparseTensor& r, const SparseTensor& t) {
  sparse_unary_op_check_and_init<true>(r, t);
  r._values().asinh_();
  return r;
}
...
SparseTensor asinh_sparse(const SparseTensor& t) {
  auto result = get_result_tensor_for_unary_op<true>(t);
  return asinh_out_sparse(result, t);
}
